...
#if !defined(CPU_MASTER) && !defined(CPU_SLAVE)
# error "CPU_MASTER or CPU_SLAVE must be defined"
#endif

#ifdef CPU_MASTER
# include "board.master.h"
#else 
# include "board.slave.h"
#endif 
