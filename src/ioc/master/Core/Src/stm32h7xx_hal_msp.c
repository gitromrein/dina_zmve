...
void HAL_FDCAN_MspDeInit(FDCAN_HandleTypeDef* hfdcan)
{
  ...
  /* USER CODE END FDCAN2_MspDeInit 0 */
    ...
    PB13     ------> FDCAN2_TX
    */
    HAL_GPIO_DeInit(GPIOB, CANFD_RX_Pin|CANFD_TX_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END UART4_MspDeInit 0 */
    ...
    PC11     ------> UART4_RX
    */
    HAL_GPIO_DeInit(GPIOC, V24_TX_Pin|V24_RX_Pin);
  ...
  /* USER CODE END UART5_MspDeInit 0 */
    ...
    PB6     ------> UART5_TX
    */
    HAL_GPIO_DeInit(GPIOB, IPK_RX_Pin|IPK_TX_Pin);
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PA10     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOA, CONP_TX_Pin|CONP_RX_Pin);
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PD9     ------> USART3_RX
    */
    HAL_GPIO_DeInit(GPIOD, DBG_TX_Pin|DBG_RX_Pin);
